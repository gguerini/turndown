...
describe Turndown::OrderedOptions do
  it 'tests usages' do
    a = Turndown::OrderedOptions.new
  ...
  it 'tests inheritable_options_continues_lookup_in_parent' do
    parent = Turndown::OrderedOptions.new
    parent[:foo] = true

    child = Turndown::InheritableOptions.new(parent)
  ...
  it 'tests inheritable_options_inheritable_copy' do
    original = Turndown::InheritableOptions.new
  ...
  it 'tests test_raises_with_bang' do
    ...
    a = Turndown::OrderedOptions.new(fake) do |key, value|
      hash[key]
    end
